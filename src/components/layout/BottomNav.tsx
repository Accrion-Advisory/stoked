  ...
  return (
    <nav
      style={{
        ...
        width: '100%',
        maxWidth: 430,
        background: 'linear-gradient(180deg, rgba(18, 20, 27, 0.86) 0%, rgba(8, 9, 12, 0.94) 100%)',
        backdropFilter: 'blur(20px)',
        WebkitBackdropFilter: 'blur(20px)',
        borderTop: '1px solid var(--border-strong)',
        borderTopLeftRadius: 22,
        borderTopRightRadius: 22,
        boxShadow: '0 -12px 32px -16px rgba(0, 0, 0, 0.9), inset 0 1px 0 rgba(255, 255, 255, 0.05)',
        display: 'flex',
        alignItems: 'center',
